        ...
        for id_tr in b:
            ...
            if len(train_loss_all) > 1:
                ...
                if (avg_loss/it) <= min_train_loss:
                    ...
                    torch.save(state, open(os.path.join(RSL_PATH, 'proto_sentiment_k100.best.pth'), 'wb'))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Training Proto-Net on sentiment classification.")
