...
def load_w2v(PATH):
    ...
    model = Word2Vec.load(PATH+'ebd/w2v_fasttext_intent.model')
        ...
        for id_tr in b:
            ...
            if len(train_loss_all) > 1:
                ...
                if (avg_loss/it) <= min_train_loss:
                    ...
                    torch.save(state, open(os.path.join(RSL_PATH, 'oproto_intent_k100.best.pth'), 'wb')) 
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Training O-Proto on intent classification.")
