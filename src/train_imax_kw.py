...
def train_kw_model(params, model, experiment, optimizer):
    ...
    save_pickle(DATA_PATH, 'tr_dev_te_kw_sentiment.pkl', (train_data, dev_data, test_data)) 
        ...
        for id_tr in b:
            ...
            if len(train_loss_all) > 1:
                ...
                if (avg_loss/it) <= min_train_loss:
                    ...
                    torch.save(state, open(os.path.join(RSL_PATH, 'imax_kw_sentiment_k100.best.pth'), 'wb'))
